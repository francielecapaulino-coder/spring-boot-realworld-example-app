...
|---|---|---|---|
| Versão Spring Boot | J3: "4.0.3" | `02-product-vision.md`, ADRs, docs/AGENTS.md: "4.0.6" | 🔶 Aguardando confirmação da PM Franciele — qual valor é o correto antes de iniciar EPIC-04 |
